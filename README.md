...
1. That user puts valid input for name, last name and email
2. that the user put required name, lastname or email input in otherwise an error message displays
3. that the input fields clear upon Submit
4. that submit is disabled if required input fields are blank
5. that error message is activated/displayed if required fields is empty
